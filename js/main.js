...
function displayData(){
    ...
    for(var i =0; i<data.length ;i++){
        ...
        cartona += `
        <div class="col-md-3">
                <div class="mymeal position-relative">   ..
...
function displayMyMeals(){
    ...
    for(var i =0; i< mycat.length ;i++){
        ...
        cartona += `
        <div class="col-md-3">
                <div class="mymeal position-relative" onclick="displayEachOneName(${datahome[i].idMeal})">
...
function showContacts() {
    document.getElementById('mydata').innerHTML = `<div class="contact min-vh-100 d-flex justify-content-center align-items-center">
...
function showSearchInputs() {
    ...
    document.getElementById("mydata").innerHTML=` <div class="container">
        ...
        <div><h3 class="text-white"><strong class="fw-bolder">Recipes </strong>:</h3> 
           ...
           ${tagStr}
                ...
                <a target="_blank" class="btn btn-danger mt-2" href="${finalEachIngreident[0].strYoutube}">Youtube</a>
                      ...
                      `;
    document.getElementById('mydata').innerHTML = carton;
    $("#inner-loading-screen").fadeOut(500);
    $("#inner-loading-screen").fadeOut(500);
    $("body").css("overflow", "visible");
  }
